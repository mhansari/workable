...
<html lang="en">
    <head>
        ...
        <meta property="og:description" content="Find best Jobs in Pakistan, jobs listings and job opportunities on CareerJin.com. Browse and apply for free! ROZEE.PK is Pakistan's leading job website where companies are posting jobs"/>
        <meta property="og:image" content="http://careerjin.com/images/logo.png" />
        <!-- Fonts -->
    ...
    <body id="app-layout">
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown dropdown-large">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Browse by City <b class="caret"></b></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          <img class="third-slide" src="images/lahore.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
