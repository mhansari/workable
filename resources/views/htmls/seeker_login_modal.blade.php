      ...
      <div class="modal-body">
      		<div id="msg2"></div>
        <div class="row">
        	{{ Form::open(array('id'=>'demo-form2', 'data-parsley-validate'=>'parsley-validate'))}}
...
<div class="col-md-12">
  {{ Form::hidden('user_type', '2', array('id' => 'user_type')) }}
                ...
                $('#submit2').on('click', function () {
                  ...
                  'ut' : 2, 
				        ...
				        success: function(data) {
				        	if(data.error){
                    $("#msg2").html('<div class="alert alert-danger" role="alert">' + data.error + '</div>');
                  }
				          else{
