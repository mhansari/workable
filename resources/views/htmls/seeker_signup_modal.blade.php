<div class="modal-header modal-header-custom">
        ...
        <h4 class="modal-title">New Job Seeker</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        {{ Html::link('#', 'Already have an account? Login now',[ 'class'=>'m', 'data-toggle'=>'modal','data-target'=>'#myModal4' ])}}
      </div>
    </div>
        ...
        <script type="text/javascript">
			     ...
			     $('.m').on('click', function(e){
			          ...
			          $.ajax({
				        type: "GET",
				        dataType: "html",
				        url: "{{route('seeker.login_html')}}",
				       async:true, 
				        success: function(data) {
				        	$('#myModal3').hide();
				        	$('#myModal4').show();
				        	 $('#modal-content3').html(data);
