        ...
        <div class="col-md-12 list-col ">
           <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    ...
                    <?php endif; ?>
                    <?php echo e(Form::open(array('url'=> route('emp.savedepartment',array('country'=>$country,'id'=>$id)) ,'class'=>'form-vertical','id'=>'demo-form', 'data-toggle'=>'validator','role'=>'form'))); ?>

            <div class="col-md-10 col-md-offet-1">
              <div class="form-group">
                <label for="title" class="col-sm-3 control-label">Name</label>
                <?php echo e(Form::input('text', 'name', $obj->name,['data-error'=>'Required','id'=>'name', 'placeholder'=>'Title', 'required'=>'required', 'class'=>'input-width form-control'])); ?>
              ...
              <div class="form-group">
                   <label for="StateID" class="col-sm-3 control-label">City</label>
                  <?php echo Form::select('CityID', $cities, $obj->city_id, ['data-error'=>'Required', 'id'=>'CityID','class'=>'input-width form-control','placeholder'=>'Select State/Province','required'=>'required']); ?>

                  <div class="help-block with-errors"></div>
              </div>
              <div class="form-group">
                <label for="address" class="col-sm-3 control-label">Description</label>
                <?php echo e(Form::textarea('description', $obj->description,['id'=>'description', 'placeholder'=>'Description',  'class'=>'input-width form-control'])); ?>
