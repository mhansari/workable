                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="img-thumbnail">
                            <a href="<?php echo e(asset('/company/' . $j->user_id)); ?>">
                    ...
                    <div class="col-md-9 mobile-center">
                        <div class="row">
                            ...
                            <div class="col-md-4 pow1">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo e(url('seekers/apply/' . $j->id )); ?>"  class="btn btn-primary btn-empty btn-lg">Apply</a> 
                                </div>
                                 <div class="col-md-6">
                        ...
                        <ul class="list-unstyled list-columns mt5 row pow">
                            <li class="col-md-3 col-xs-6 result result-border">
                                ...
                                <a href="<?php echo e(asset('jobs/'.$config['DEFAULT_COUNTRY']->v .'/' . $j->jobtype->seo )); ?>" title="<?php echo e($j->jobtype->name); ?> Jobs in Pakistan"><?php echo e($j->jobtype->name); ?></a>
                            </li>
                            <li class="col-md-3 col-xs-6 result result-border">
                                <div class="text-muted">Shift</div>
                                <a href="<?php echo e(asset('jobs/'.$config['DEFAULT_COUNTRY']->v .'/' . $j->shift->seo )); ?>" title="<?php echo e($j->shift->name); ?> Jobs in Pakistan"><?php echo e($j->shift->name); ?></a>
                            </li>
                            <li class="col-md-3 col-xs-6 result result-border">
                                <div class="text-muted">Experiance</div>
                                <a href="<?php echo e(asset('jobs/'.$config['DEFAULT_COUNTRY']->v .'/' . $j->experiance->seo )); ?>" title="<?php echo e($j->experiance->name); ?> Jobs in Pakistan"><?php echo e($j->experiance->name); ?></a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-7 col-xs-7 cell">
                            <a href="<?php echo e(asset('/jobs/'.$config['DEFAULT_COUNTRY']->v .'/' . $j->categories->seo )); ?>" title="<?php echo e($j->categories->name); ?> Jobs in Pakistan"><?php echo e($j->categories->name); ?></a>
                        </div>
...
<div class="hor mbc"></div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php echo strlen($j->companies->about_company)>255?substr($j->companies->about_company,0,255) . '<br/><a href="'.asset('/company/' . $j->user_id).'">[more]</a>' : $job->description; ?>
