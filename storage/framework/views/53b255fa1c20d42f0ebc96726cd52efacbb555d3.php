        ...
        <div class="col-md-6 list-col col-md-offset-3">
           <div class="panel panel-default">
                ...
                <div class="panel-body ">
                   ...
                   <?php echo e(Form::open(array('onload'=>'javascript:alert("hi")','url'=> route('emp.signup',array('country'=>$country)),'id'=>'demo-form', 'data-toggle'=>'validator','role'=>'form'))); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::input('text', 'firstname', '',['data-error'=>'Required','id'=>'firstname', 'placeholder'=>'First Name', 'required'=>'required', 'class'=>'form-control'])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::input('text', 'lastname', '',['data-error'=>'Required','id'=>'lastname', 'placeholder'=>'Last Name', 'required'=>'required', 'class'=>'form-control'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('gender', array('M'=>'Male','F'=>'Female'), null, ['data-error'=>'Required', 'id'=>'gender','class'=>'form-control','placeholder'=>'Gender','required'=>'required']); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('CountryID', $countries, null, ['data-error'=>'Required', 'id'=>'CountryID','class'=>'form-control','placeholder'=>'Select Country','required'=>'required']); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('StateID', $states, null, ['' => '','data-error'=>'Required', 'id'=>'StateID','class'=>'form-control','placeholder'=>'Select State/Province','required'=>'required']); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('CityID', $cities, null, ['data-error'=>'Required', 'id'=>'CityID','class'=>'form-control','placeholder'=>'Please select City','required'=>'required']); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::input('text', 'mobile_number', '',['data-error'=>'Required','id'=>'mobile_number', 'placeholder'=>'Mobile Number', 'required'=>'required', 'class'=>'form-control'])); ?>
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::input('password', 'confirm_password', '',['data-error'=>'Password does not match','id'=>'confirm_password', 'data-match'=>'#password', 'placeholder'=>'Confirm Password', 'required'=>'required', 'class'=>'form-control'])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('QuestionID', $questions, null, ['data-error'=>'Required', 'id'=>'QuestionID','class'=>'form-control','placeholder'=>'Select Security Question','required'=>'required']); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::input('text', 'security_answer', old('security_answer'),['data-error'=>'Required','id'=>'security_answer', 'placeholder'=>'Your Security Answer', 'required'=>'required', 'class'=>'form-control'])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo e(Form::checkbox('newsletter', '1', '',['id'=>'newsletter'])); ?> Subscribe to daily job alerts?
                            </div>
                        </div>

                        <div class="col-md-12">
                            By clicking on <b>Submit</b> button you are agreeing to the (TOS).
                        </div><?php echo Form::token(); ?>
