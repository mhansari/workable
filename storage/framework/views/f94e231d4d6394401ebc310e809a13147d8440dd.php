                ...
                <div class="panel-body search-ul-padding">
                    <?php echo e(Form::open(array('url'=>route('advsearch',array('country'=>$cntry->seo)),'id'=>'demo-form', 'data-parsley-validate'=>'parsley-validate'))); ?>
                     ...
                     <ul class="list-group ">
                        ...
                        <li class="col-sm-6 list-group-item form-list form-sm search-li-padding-right"><?php echo Form::input('text','MinS', null, ['id'=>'MinS','class'=>'form-control search-exp-text-box','placeholder'=>'Min Sal']); ?></li>
                        <li class="col-sm-6 list-group-item form-list form-sm search-li-padding-left"><?php echo Form::input('text','MaxS',  null, ['id'=>'MaxS','class'=>'form-control search-exp-text-box','placeholder'=>'Max Sal']); ?></li>                       
