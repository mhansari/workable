            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">                    
                    <ul class="media-list row list-compact">
                       ...
                       <a href="<?php echo e(asset($country . '/company/' . $job->companies->user_id)); ?>">
                                            <div class="thumb-latest" style="width: 50px; height: 50px; line-height: inherit; background-color: transparent; font-size: 25px;">
                                                <span class="helper"></span>
                                                
                                                <img src="<?php echo e($job->companies->company_logo); ?>" alt="<?php echo e($job->companies->company_name); ?>">
                                ...
                                <div class="media-body">
                                    <div class="media-heading b" style="height:16px;overflow:hidden;"><a href="<?php echo e(asset($country .'/jobs/' . $job->id)); ?>"><?php echo e($job->job_title); ?></a></div>
                                    <div class="text-sm">
                            ...
                            <div class="box">
                                <div class="media-left pt0 pr10">
                                    <a href="<?php echo e(asset($country . '/seekers/profile/' . $seeker->id)); ?>">
                                                ...
                                                <span class="helper"></span>
                                                <img src="<?php echo e($seeker->pp==''?'pp/placeholder.png':$seeker->pp); ?>" alt="<?php echo e($seeker->first_name); ?> <?php echo e($seeker->last_name); ?>">
                                            </div>
