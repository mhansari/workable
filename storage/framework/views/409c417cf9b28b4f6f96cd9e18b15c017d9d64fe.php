        ...
        <div class="col-md-9 list-col ">
           <div class="panel panel-default">
                ...
                <div class="panel-body ">
                   ...
                   <?php echo e(Form::open(array('class'=>'form-vertical','url'=> route('experiance.save', array('country'=>$country,'id' => $id,'resumeid'=>$resumeid)),'id'=>'demo-form', 'data-toggle'=>'validator','role'=>'form'))); ?>

                    <div class="form-group">
                        <label for="job_title" class="col-sm-3 control-label">Job Title</label>
                        <?php echo e(Form::input('text', 'job_title', $experiance->job_title,['data-error'=>'Required','id'=>'job_title', 'placeholder'=>'Job Title', 'required'=>'required', 'class'=>'input-width form-control'])); ?>

                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                        <label for="org" class="col-sm-3 control-label">Organization</label>
                        <?php echo e(Form::input('text', 'org', $experiance->organization,['data-error'=>'Required','id'=>'org', 'placeholder'=>'Organization', 'required'=>'required', 'class'=>'input-width form-control'])); ?>

                        <div class="help-block with-errors"></div>
                    </div>                     
                    <div class="form-group">
                        <label for="CountryID" class="col-sm-3 control-label">Country</label>
                        <?php echo Form::select('CountryID', $countries, $experiance->country_id, ['data-error'=>'Required', 'id'=>'CountryID','class'=>'input-width form-control','placeholder'=>'Select Country','required'=>'required']); ?>

                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                        <label for="StateID" class="col-sm-3 control-label">State/Province</label>
                        <?php echo Form::select('StateID', $states, $experiance->state_id, ['data-error'=>'Required', 'id'=>'StateID','class'=>'input-width form-control','placeholder'=>'Select State/Province','required'=>'required']); ?>

                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                        <label for="CityID" class="col-sm-3 control-label">City</label>
                        <?php echo Form::select('CityID', $cities, $experiance->city_id, ['data-error'=>'Required', 'id'=>'CityID','class'=>'input-width form-control','placeholder'=>'Please select City','required'=>'required']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo e(Form::checkbox('current_work',1,$experiance->current_working,['id'=>'current_work'])); ?>
                    ...
                    <div class="form-group"> 
                        <label for="details" class="col-sm-3 control-label">Details</label>
                         <div class="col-md-9 professional-summary">
                            <?php echo e(Form::textArea('details', $experiance->details,['data-error'=>'Required','id'=>'details', 'placeholder'=>'Details', 'required'=>'required', 'class'=>'input-width-currency form-control'])); ?>
...
<?php if($id!= 0): ?>
var s = selectState(<?php echo e($experiance->country_id); ?>, <?php echo e($experiance->state_id); ?>);


selectCity(<?php echo e($experiance->state_id); ?>,<?php echo e($experiance->city_id); ?>);
<?php endif; ?>
