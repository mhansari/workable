        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Interviews
              <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="<?php echo e(asset($country .'/employers/interviews')); ?>">Scheduled Interviews</a></li>
              <li><a href="<?php echo e(asset($country .'/employers/vanues')); ?>">Vanues</a></li>
              <li><a href="<?php echo e(asset($country .'/employers/update-vanue')); ?>">Add new Vanue</a></li>
            </ul>
            </li> 
            ...
            <li><a href="<?php echo e(route('update.company',array('country'=>$country))); ?>">Update Company</a></li> 
                ...
                <ul class="dropdown-menu">
                  <li>Account</li>
                    ...
                    <li>Organizaton</li>
                      ...
                      <li><a href="<?php echo e(asset($country .'/employers/vanues')); ?>">Interview Venues</a></li>
                    </ul> 
                </ul>
            </li> 
          </ul>
