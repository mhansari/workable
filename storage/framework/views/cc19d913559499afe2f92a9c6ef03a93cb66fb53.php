                ...
                <div class="panel-body ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row ans-margin-top">
                                <div class="col-md-11 col-md-offset-1 ans-label-margin">
                                    <?php echo e($obj->careerlevel->name); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row ans-margin-top">
                                <div class="col-md-11 col-md-offset-1 ans-label-margin">
                                    <?php echo e($obj->experiancelevel->name); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row ans-margin-top">
                                <div class="col-md-11 col-md-offset-1 ans-label-margin">
                                    <?php echo e($obj->required_skills); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row ans-margin-top">
                                <div class="col-md-11 col-md-offset-1 ans-label-margin">
                                    <?php echo e($obj->shift_timings->name); ?>
                    ...
                    <?php if($obj->required_travelling): ?>
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="row ans-padding-top">
                                <div class="col-md-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11 col-md-offset-1"> 
                           <?php echo Form::select('resume', $resumes, '', ['data-error'=>'Required', 'id'=>'resume','class'=>'input-width form-control','placeholder'=>'Select Resume','required'=>'required']); ?>
                    ...
                    <input type="hidden" name="job_id" id="job_id" value="<?php echo e($jobid); ?>"/>
                    <?php echo Form::token(); ?>
