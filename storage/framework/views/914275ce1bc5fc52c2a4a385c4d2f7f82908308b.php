<div class="modal-header modal-header-custom">
      ...
      <div class="modal-body">
            <div id="msg"></div>
        <div class="row">
            <?php echo e(Form::open(array('id'=>'demo-form1', 'data-parsley-validate'=>'parsley-validate'))); ?>
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo e(Form::input('text', 'Department', '',['data-parsley-required-message'=>'Required','id'=>'Department', 'placeholder'=>'Department Name', 'required'=>'required', 'class'=>'form-control'])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo Form::select('CountryID', $countries, null, ['data-parsley-required-message'=>'Required', 'id'=>'CountryID','class'=>'form-control','placeholder'=>'Select Country','required'=>'required']); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo Form::select('StateID', $states, null, ['data-parsley-required-message'=>'Required', 'id'=>'StateID','class'=>'form-control','placeholder'=>'Select State/Province','required'=>'required']); ?>

                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo Form::select('CityID', $cities, null, ['data-parsley-required-message'=>'Required', 'id'=>'CityID','class'=>'form-control','placeholder'=>'Select City','required'=>'required']); ?>

                            </div>
                        </div>
                    <div class="col-md-12">
                            <div class="form-group">
                                <?php echo Form::textArea('description','', ['data-parsley-required-message'=>'Required', 'id'=>'description','class'=>'form-control','placeholder'=>'Description','required'=>'required']); ?>
 ...
 <!-- form validation -->
    <script src="<?php echo e(asset('js/validator/validator.js')); ?>"></script>
 ...
 window.ParsleyConfig.validators.date = {
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/parsley/parsley.min.js')); ?>"></script>
            <!-- form validation -->
        <script type="text/javascript">
                 ...
                 $('#submit1').on('click', function () {
                  ...
                  //$date=strtotime($('#dob').val());
                    $.ajax({
                       ...
                       'employer_id': <?php echo e(Auth::user()->id); ?>,
