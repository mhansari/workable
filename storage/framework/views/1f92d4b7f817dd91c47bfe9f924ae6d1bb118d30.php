...
<div class="hor mbc"></div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php echo strlen($j->companies->about_company)>255?substr($j->companies->about_company,0,255) . '<br/><a href="'.asset($country .'/company/' . $j->user_id).'">[more]</a>' : $j->companies->about_company; ?>
