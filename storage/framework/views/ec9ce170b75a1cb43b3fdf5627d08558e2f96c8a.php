                ...
                <div class="panel-body ">
                    ...
                    <div class="panel panel-default"><div class="panel-body ">
                         <ul class="list-group box-search">
                            <li class="col-md-10 list-group-item result "><a href="<?php echo e(asset($country .'/jobs/' . $job->id)); ?>"><strong><?php echo e($job->job_title); ?></strong></a></li>
                            ...
                            <li class="col-md-12 list-group-item result">
                                <a href="<?php echo e(asset($country .'/company/'.$job->user_id)); ?>" title="Full-Time Jobs in Pakistan"><?php echo e($job->companies->company_name); ?></a>
                            </li>
                            <li class="col-md-3 list-group-item result result-border">
                                <div class="text-muted">Job Type</div>
                                <a href="<?php echo e(asset($country .'/jobs/job-type/'. $job->jobtype['seo'] )); ?>" title="<?php echo e($job->jobtype['name']); ?> Jobs in Pakistan"><?php echo e($job->jobtype['name']); ?></a>
                            </li>
                            <li class="col-md-3 list-group-item result result-border">
                                <div class="text-muted">Shift</div>
                                <a href="<?php echo e(asset($country .'/jobs/shift/'. $job->shift['seo'] )); ?>" title="<?php echo e($job->shift['name']); ?> Jobs in Pakistan"><?php echo e($job->shift['name']); ?></a>
                            </li>
                            <li class="col-md-3 list-group-item result result-border">
                                <div class="text-muted">Experiance</div>
                                <a href="<?php echo e(asset($country .'/jobs/experiance/'. $job->experiance['seo'] )); ?>" title="<?php echo e($job->experiance['name']); ?> Jobs in Pakistan"><?php echo e($job->experiance['name']); ?></a>
                            </li>
